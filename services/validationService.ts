...
const propertySchema = z.object({
  ...
  description: z.string().trim().nonempty({ message: 'Debe ingresar una descripción' }).max(300, {
  ...
  lat: z.string().nonempty({ message: 'Debe seleccionar una ubicación en el mapa' }),
